...
router.get('/cocktailInfo', async (req, res) => {
    ...
    // console.log(data.strDrinkThumb)

    // let strDrink = data.strDrink;
    // let strDrinkThumb = data.strDrinkThumb;
    res.render('cocktailInfo', {
        data,
        title: `You have been given cocktail ${data}`
    }); 
        // strDrink: strDrink,
...
//     let data = await getWeather.getNasaImage()
//     console.log(data)
//     res.render('getNasaImage', {data: {date,explanation,url}});
// })
